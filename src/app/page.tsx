...
import { Workshops } from "@/components/ui/Workshops";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div 
        className="pointer-events-none fixed inset-0 z-0 opacity-20 dark:opacity-30 bg-cover bg-center bg-no-repeat"
